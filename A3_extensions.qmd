...
　2026年2月現在、百を超える数の拡張機能がある^[拡張機能のリストは<https://quarto.org/docs/extensions/>から確認できる。]。
Quarto公式で開発した拡張機能もあれば、ユーザーが作成した拡張機能もある。CRANのように公式レポジトリを使用せず、GitHubを使用するため、LUA言語の知識があれば誰でも拡張機能を作成し、公に公開することができる^[公式に一報知らせたらリストにも掲載してくれるらしい。]。

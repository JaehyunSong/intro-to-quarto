...
- 導入手順
   ...
   1. {quarto}、{magick}、{ragg}、{tidyverse}等のパッケージをインストールする
...
- 起動方法
   - <https://mybinder.org/v2/gh/JaehyunSong/quarto_binder/HEAD>
...
- ファイルをダウンロードし、プロジェクトフォルダー内に解凍
   - <https://www.jaysong.net/intro-to-quarto/data/intro-to-quarto.zip>
